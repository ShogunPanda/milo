...
void append_output(const milo::Parser* parser, uchar_t* message, const uchar_t* data, usize_t from, usize_t size) {
  if (data == NULL) {
    printf("{ %s, \"data\": null }\n", message);
  } else {
...
void event(const milo::Parser* parser, const char* name, const uchar_t* data, usize_t from, usize_t size) {
...
void show_span(const milo::Parser* parser, const char* name, const uchar_t* data, usize_t from, usize_t size) {
