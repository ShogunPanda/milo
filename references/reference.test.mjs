...
function debugOutput(allCallbacks) {
  return `
    ...
    { "pos": 0, "event": "begin", "configuration": { "debug": true, "all-callbacks": ${allCallbacks} }, "data": null }
    { "pos": 0, "event": "request", "data": null }
    ...
    { "pos": 11, "event": "before_state_change", "current_state": "REQUEST_VERSION", "data": null }
    { "pos": 11, "event": "after_state_change", "current_state": "HEADER_NAME", "data": null }
    ...
    { "pos": 18, "event": "before_state_change", "current_state": "START", "data": null }
    { "pos": 18, "event": "after_state_change", "current_state": "MESSAGE", "data": null }
    { "pos": 18, "consumed": 18, "state": "MESSAGE" }
    
    ------------------------------------------------------------------------------------------
    
    { "pos": 0, "event": "begin", "configuration": { "debug": true, "all-callbacks": ${allCallbacks} }, "data": null }
    { "pos": 0, "event": "response", "data": null }
    { "pos": 0, "event": "before_state_change", "current_state": "MESSAGE", "data": null }
    ...
    { "pos": 15, "event": "before_state_change", "current_state": "RESPONSE_REASON", "data": null }
    { "pos": 15, "event": "after_state_change", "current_state": "HEADER_NAME", "data": null }
    ...
    { "pos": 67, "event": "after_state_change", "current_state": "BODY", "data": null }
    { "pos": 67, "event": "before_state_change", "current_state": "BODY", "data": null }
    ...
    { "pos": 117, "event": "before_state_change", "current_state": "START", "data": null }
    { "pos": 117, "event": "after_state_change", "current_state": "MESSAGE", "data": null }
    { "pos": 117, "consumed": 117, "state": "MESSAGE" }
  `
}

function releaseOutput(allCallbacks) {
  return `
    { "pos": 0, "event": "begin", "configuration": { "debug": false, "all-callbacks": ${allCallbacks} }, "data": null }
    { "pos": 0, "event": "request", "data": null }
    { "pos": 0, "event": "method", "data": "GET" }
    { "pos": 4, "event": "url", "data": "/" }
    { "pos": 6, "event": "protocol", "data": "HTTP" }
...
test('reference-release-default', t => {
  verifyOutput('reference-release-default', releaseOutput(false))
})

test('reference-release-all-callbacks', t => {
  verifyOutput('reference-release-all-callbacks', releaseOutput(true))
})

test('reference-debug-default', async t => {
  verifyOutput('reference-debug-default', debugOutput(false))
})

test('reference-debug-all-callbacks', async t => {
  verifyOutput('reference-debug-all-callbacks', debugOutput(true))
})
